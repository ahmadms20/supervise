...
export function ResponsiveDrawer(props) {
  ...
  const id1 = localStorage.getItem('nip')
  const id2 = localStorage.getItem('nip2')
  const id3 = localStorage.getItem('nip3')
  const id4 = localStorage.getItem('nip4')
  const bulan = localStorage.getItem('bulan')
  const tahun = localStorage.getItem('tahun')
  console.log("wewe", id4)
  const drawer = (
    // Menu sidebar
    <div>
      ...
      <Divider light />
        <ListItem button component={NavLink} to="/dashboard-admin" id="menu" activeClassName="active">
          <ListItemIcon>
      ...
      <Divider light/>
        <ListItem button component={NavLink} to="/absen-admin" id="menu" isActive={() => ['/absen-admin', `/absen/filter/${id3}`, `/absen/detail/${id4}/${bulan}/${tahun}`].includes(pathname)} activeClassName="active">
          <ListItemIcon>
      ...
      <Divider light/>
        <ListItem button component={NavLink} to="/kegiatan-admin" isActive={() => ['/kegiatan-admin', `/admin-kegiatan/filter/${id1}`, `/detail-kegiatan/detail/${id2}`].includes(pathname)} id="menu" activeClassName="active">
          <ListItemIcon>
      ...
      <Divider light/>
        <ListItem button component={NavLink} to="/jadwal-admin" id="menu" activeClassName="active">
          <ListItemIcon>
