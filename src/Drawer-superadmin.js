...
import Karyawan from './img/team.png';
import Akun from './img/user.png';
...
export function ResponsiveDrawer(props) {
  ...
  const drawer = (
    ...
    <div>
      ...
      <Divider light />
        <ListItem button component={NavLink} to="/dashboard-superadmin" id="menu" activeClassName="active">
          <ListItemIcon>
      ...
      <Divider light/>
        <ListItem button component={NavLink} to="/akun" id="menu" activeClassName="active">
          <ListItemIcon>
            <img style={{width:'20px'}} src={Akun} />
          </ListItemIcon>
          <ListItemText primary="Akun" activeClassName="active"/>
        </ListItem>
      <Divider light/>
        <ListItem button component={NavLink} to="/data-karyawan" id="menu" activeClassName="active">
          <ListItemIcon>
            <img style={{width:'20px'}} src={Karyawan} />
          </ListItemIcon>
          <ListItemText primary="Karyawan" activeClassName="active"/>
        </ListItem>
    </div>
    // Menu sidebar
  );
