...
class Profilkaryawan extends React.Component{
  constructor(props){
    super(props);
      this.state = {
        dataprofil: []
...
updatePassword (data) {
  console.log(data)
  axios.patch(url.api+"/pegawai/akun/password",data,{headers: { 'Authorization':  `token=${token}` }}).then(res=>{
    console.log(res.data)
    if(!res.data.data){
      Swal.fire({
...
Profilkaryawan.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(Profilkaryawan);