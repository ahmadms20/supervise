...
class Profilsuperadmin extends React.Component{
  constructor(props){
    super(props);
      this.state = {
        dataprofil: []
...
updatePassword (data) {
  axios.patch(url.api+"/superadmin/akun/password",data,{headers: { 'Authorization':  `token=${token}` }}).then(res=>{
    console.log(res.data)
    if(!res.data.data){
      Swal.fire({
...
Profilsuperadmin.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(Profilsuperadmin);